      ...
      <div className="flex justify-around flex-wrap gap-4">
        ...
        <div>
          <div>
            ...
            >
              <img
                className="object-cover w-full rounded-t-lg h-full md:h-auto md:w-[180px] md:rounded-none md:rounded-s-lg"
                src="/3d-partners.png"
                alt=""
              />
              <div className="flex flex-col justify-between p-4 leading-normal pb-16">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">
                  3D Geometry
                </h5>
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
